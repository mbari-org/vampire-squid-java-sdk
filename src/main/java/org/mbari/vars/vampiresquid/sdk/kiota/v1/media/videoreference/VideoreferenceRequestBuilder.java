package org.mbari.vars.vampiresquid.sdk.kiota.v1.media.videoreference;
...
import org.mbari.vars.vampiresquid.sdk.kiota.v1.media.videoreference.filename.FilenameRequestBuilder;
import org.mbari.vars.vampiresquid.sdk.kiota.v1.media.videoreference.item.WithVideoReferenceUuItemRequestBuilder;
/**
...
public class VideoreferenceRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link FilenameRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public FilenameRequestBuilder filename() {
        return new FilenameRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Gets an item from the org.mbari.vars.vampiresquid.sdk.kiota.v1.media.videoreference.item collection
    ...
    public VideoreferenceRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/media/videoreference", pathParameters);
    }
    /**
     * Instantiates a new {@link VideoreferenceRequestBuilder} and sets the default values.
    ...
    public VideoreferenceRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/media/videoreference", rawUrl);
    }
}
