...
public class VideoSequenceCreate implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new {@link VideoSequenceCreate} and sets the default values.
     */
    public VideoSequenceCreate() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link VideoSequenceCreate}
     */
    @jakarta.annotation.Nonnull
    public static VideoSequenceCreate createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VideoSequenceCreate();
    }
    /**
