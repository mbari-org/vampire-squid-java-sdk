...
public class Unauthorized extends ApiException implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Unauthorized} and sets the default values.
     */
    public Unauthorized() {
     ...
     * @return a {@link Unauthorized}
     */
    @jakarta.annotation.Nonnull
    public static Unauthorized createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
