package org.mbari.vars.vampiresquid.sdk.kiota.v1.videoreferences.item;
...
import org.mbari.vars.vampiresquid.sdk.kiota.models.VideoReferenceUpdate;
/**
...
public class WithUuItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithUuItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/videoreferences/{uuid}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithUuItemRequestBuilder} and sets the default values.
    ...
    public WithUuItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/videoreferences/{uuid}", rawUrl);
    }
    /**
     * Delete a video reference by UUID
    ...
    /**
     * Find a video reference by UUID
    ...
    /**
     * Update a video reference by UUID
     ...
     */
    @jakarta.annotation.Nullable
    public VideoReference put(@jakarta.annotation.Nonnull final VideoReferenceUpdate body) {
     ...
     */
    @jakarta.annotation.Nullable
    public VideoReference put(@jakarta.annotation.Nonnull final VideoReferenceUpdate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final VideoReferenceUpdate body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final VideoReferenceUpdate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
