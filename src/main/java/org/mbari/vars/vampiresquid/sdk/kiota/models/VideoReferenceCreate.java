...
public class VideoReferenceCreate implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link VideoReferenceCreate} and sets the default values.
     */
    public VideoReferenceCreate() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link VideoReferenceCreate}
     */
    @jakarta.annotation.Nonnull
    public static VideoReferenceCreate createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VideoReferenceCreate();
    }
    /**
