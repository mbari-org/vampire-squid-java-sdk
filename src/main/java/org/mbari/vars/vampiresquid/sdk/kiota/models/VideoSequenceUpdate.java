...
public class VideoSequenceUpdate implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new {@link VideoSequenceUpdate} and sets the default values.
     */
    public VideoSequenceUpdate() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link VideoSequenceUpdate}
     */
    @jakarta.annotation.Nonnull
    public static VideoSequenceUpdate createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VideoSequenceUpdate();
    }
    /**
