...
public class BadRequest extends ApiException implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BadRequest} and sets the default values.
     */
    public BadRequest() {
     ...
     * @return a {@link BadRequest}
     */
    @jakarta.annotation.Nonnull
    public static BadRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
