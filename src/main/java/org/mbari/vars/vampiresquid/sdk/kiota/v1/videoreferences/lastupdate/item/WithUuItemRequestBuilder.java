package org.mbari.vars.vampiresquid.sdk.kiota.v1.videoreferences.lastupdate.item;
...
public class WithUuItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithUuItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/videoreferences/lastupdate/{uuid}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithUuItemRequestBuilder} and sets the default values.
    ...
    public WithUuItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/videoreferences/lastupdate/{uuid}", rawUrl);
    }
    /**
     * Find the last update time for a video reference by UUID
     * @return a {@link LastUpdatedTime}
     * @throws BadRequest When receiving a 400 status code
     * @throws NotFound When receiving a 404 status code
     * @throws ServerError When receiving a 500 status code
     */
    @jakarta.annotation.Nullable
    public LastUpdatedTime get() {
        return get(null);
    }
    /**
     * Find the last update time for a video reference by UUID
     ...
     */
    @jakarta.annotation.Nullable
    public LastUpdatedTime get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("400", BadRequest::createFromDiscriminatorValue);
        errorMapping.put("404", NotFound::createFromDiscriminatorValue);
        errorMapping.put("500", ServerError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, LastUpdatedTime::createFromDiscriminatorValue);
    }
    /**
     * Find the last update time for a video reference by UUID
